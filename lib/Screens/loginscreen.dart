...
import 'package:rider_app/Screens/homescreen.dart';
          ...
          child: SizedBox(
            ...
            child: showLoading
                ...
                : ListView(
                    ...
                    children: [
                      if (currentState ==
                              MobileVerificationState.SHOW_MOBILE_FORM_STATE) TextFieldMethod(maxWidth, maxHeight / 1.7, context) else getOtpFormWidget()
                    ],
                  ),
          ),
        ),
